...
public class JNDIAndSaltAwareJdbcRealm extends JdbcRealm {
	...
	SimpleAuthenticationInfo info = new SimpleAuthenticationInfo(username, passwdSalt.getPassword(), getName());
	info.setCredentialsSalt(new SimpleByteSource(passwdSalt.getSalt()));
