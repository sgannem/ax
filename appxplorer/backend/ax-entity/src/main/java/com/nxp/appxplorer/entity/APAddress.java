...
/**
 * This class maps APAddress table into the Data Base.
 * 
 */
@Entity
public class APAddress extends AbstractStrongEntity {
    ...
    /**
     * It builds AP Address object.
     * 
     * @return
     */
    private APAddress(Builder builder) {
    ...
    @JsonIgnoreProperties(value = "APAddress")
	...
	final APAddress that = (APAddress) o;
	return Objects.equals(getId(), that.getId());
    }

    /**
     * It builds AP Address Builder object.
     * 
     * @return
     */
    ...
    /**
     * This Builder class helps to build AP Address Builder objects.
     * 
     */
	...
	public APAddress build() {
	    return new APAddress(this);
	}
    }
