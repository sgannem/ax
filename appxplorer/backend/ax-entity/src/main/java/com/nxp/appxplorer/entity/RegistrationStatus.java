...
/**
 * This class maps RegistrationStatus table into the Data Base.
 * 
 */
@Entity
public class RegistrationStatus extends AbstractStrongShortEntity {
	...
	public String toString() {
		return "RegistrationStatus [id=" + getId() + ", name=" + name + ", description=" + description + ", isActive="
				+ isActive + "]";
	}
