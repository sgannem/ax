...
public class UpdateAccountDetailsResponse {
    ...
    public UpdateAccountDetailsResponse(Builder builder) {
	...
	return "UpdateAccountDetailsResponse [userName=" + userName + ", accountType=" + accountType + ", loginType="
	...
	public UpdateAccountDetailsResponse build() {
	    return new UpdateAccountDetailsResponse(this);
	}
    }
