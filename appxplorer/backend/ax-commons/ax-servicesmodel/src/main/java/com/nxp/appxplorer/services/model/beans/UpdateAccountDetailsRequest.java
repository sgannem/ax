...
public class UpdateAccountDetailsRequest {
    ...
    public UpdateAccountDetailsRequest(Builder builder) {
	...
	return "UpdateAccountDetailsRequest [userName=" + userName + ", accountType=" + accountType + ", loginType="
	...
	public UpdateAccountDetailsRequest build() {
	    return new UpdateAccountDetailsRequest(this);
	}
    }
