package com.nxp.appxplorer.commons.services.filter;
...
/**
 * Replacement for Guice's {@code PersistFilter}. This filter suppresses the
 * {@link IllegalStateException} that is thrown when the {@code
...
public class SilentPersistFilter implements Filter {
	...
	try {
	    ...
	    LOGGER.error("Hide exception: {}", e.getMessage(), e);
	}
    }
